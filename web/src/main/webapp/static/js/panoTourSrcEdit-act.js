...
$(document).ready(function () {
    ...
    $('.bs-edit-scena').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            url: 'ajaxForm/ajaxGetScenaFormByNameAndTourId',
            success: function (scenaForm) {
                ...
                embedpano({swf:"/krengine/pano.swf", xml:"getPanoTourScene.xml?scenaId="+$('#scenaForm input#id').val(), target:"scenaNorth"});
    ...
    $('#srcReloadBtn').on('click', function () {
        var id = $("#id").val();
        $.ajax({
            async: true,
            type: 'POST',
            data: "id="+id,
            url: 'ajaxReloadPanoTourSrc',
            success: function (data) {
                switch (data) {
                    case 'SUCCESS':
                        new PNotify({
                            title: 'Обновление',
                            text: 'Обновление исходника произошло успешно!',
                            type: 'success'
                        });
                    ...
                    case 'ERROR':
                        new PNotify({
                            title: 'Обновление',
                            text: 'Произошла ошибка при обновлении исходников!',
                            type: 'error'
                        });
                        break;
                    default:
