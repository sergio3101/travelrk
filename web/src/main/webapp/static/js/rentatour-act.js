$(document).ready(function () {
    ...
    var linkEdit = function(e, cell){
        window.location = 'rentaTourEdit-'+cell.getRow().getData().id;
    };
    ...
    var scntbl = new Tabulator("#tabulator-table", {
