...
;(function (global, factory) {
    ...
    // Return a moment from input, that is local/utc/zone equivalent to domain.
	...
	var defaultConfig = {
		...
		scales: {
			xAxes: [{
				...
				position: "bottom",
				id: "x-axis-1" // need an code so datasets can reference the scale
			}],
			yAxes: [{
				type: "linear",
				position: "left",
	...
	Chart.defaults.bubble = {
		...
		scales: {
			xAxes: [{
				...
				position: "bottom",
				id: "x-axis-0" // need an code so datasets can reference the scale
			}],
			yAxes: [{
				type: "linear",
				position: "left",
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, {
		...
		/**
		 * Builds a map of scale code to scale object for future lookup.
		 */
...
module.exports = function(Chart) {
	...
	helpers.getRelativePosition = function(evt, chart) {
		...
		// the backend domain is in unscaled coordinates. Since we are going to deal with our domain coordinates, we go back here
