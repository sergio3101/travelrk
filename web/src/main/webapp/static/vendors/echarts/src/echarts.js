...
define(function (require) {
    ...
    var GlobalModel = require('./domain/Global');
    var ExtensionAPI = require('./ExtensionAPI');
    var CoordinateSystemManager = require('./CoordinateSystem');
    var OptionManager = require('./domain/OptionManager');

    var ComponentModel = require('./domain/Component');
    var SeriesModel = require('./domain/Series');
