...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/domain/Global
	     *
	     * @param {Object} option
	    ...
	    var GlobalModel = Model.extend({
	        ...
	        mergeOption: function (newOption) {
	            ...
	            // 如果不存在对应的 component domain 则直接 merge
	         ...
	         *     ...
	         * });
	         * eachComponent(function (componentType, domain, index) {
	    ...
	    function mergeTheme(option, theme) {
	        for (var name in theme) {
	            // 如果有 component domain 则把具体的 merge 逻辑交给该 domain 处理
	    ...
	    /**
	     * @inner
	     * @param {Array.<string>|string} types domain types
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // no-merge mode. So we generate domain id by name and plus
	        // type in view id.
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/domain/Model
	     * @constructor
	     * @param {Object} option
	     * @param {module:echarts/model/Model} [parentModel]
	     * @param {module:echarts/model/Global} [ecModel]
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * @alias module:echarts/domain/Component
	     * @constructor
	     * @param {Object} option
	     * @param {module:echarts/model/Model} parentModel
	    ...
	    var ComponentModel = Model.extend({
	        ...
	        /**
	         * key: componentType
	         * value:  Component domain list, can not be null.
	         * @type {Object.<string, Array.<module:echarts/model/Model>>}
	         * @readOnly
	         */
	        dependentModels: [],
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     *     };
	     *
	     * @alias module:echarts/domain/OptionManager
	    ...
	    OptionManager.prototype = {
	        ...
	        mountOption: function (isRecreate) {
	            ...
	            return clone(isRecreate
	                ...
	                // proformed by `domain.mergeOption`.
	     ...
	     * 1. Each domain handle its self restoration but not uniform treatment.
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     * @param {string} [axisType] Default retrieve from domain.type
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Generate sub axis domain class
...
/***/ function(module, exports, __webpack_require__) {
	     ...
	     *                                     interval from domain is null or 'auto'.
