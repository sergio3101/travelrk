...
<head>
    ...
    <title>Тур - ${panoTourSrc.name}</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Эксклюзивный тур -
                                <small>${panoTourSrc.name}</small>
                            </h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <form:form method="post" action="/admin/panoTourSrcEdit"
                                       modelAttribute="panoTourSrc"
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <a href="/admin/panotoursrc" class="btn btn-info pull-right"
                                       style="margin-top: 5px;">Закрыть</a>
                                    <a id="srcReloadBtn" class="btn btn-info pull-right">Обновить</a>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="main">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10"><a href="${panoTourSrcHtml}"
                                                                          target="_blank">${panoTourSrcHtml}</a>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-2"><strong>Дата загрузки тура:</strong></div>
                                                <div class="col-md-10">${panoTourSrc.dateOfCreate}</div>
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <div class="tab-pane" id="tourscens">
                                            ...
                                            <c:forEach var="scena" items="${panoTourSrc.scenes}">
                                                <div class="col-md-55">
                                                    <div class="thumbnail">
                                                        <div class="image view view-first">
                                                            <div class="scene_preview_img">
                                                                <img src="${panoTourSrc.path}/${scena.dir}/preview.jpg"
                                                                    alt="image"/>
                                                            </div>
                                                            <div class="mask">
                                                                <p>${fn:substring(scena.title, 0, 26)}...</p>
                                                                <div class="tools tools-bottom">
                                                                    <a href="${panoTourSrcHtml}?startscene=${scena.name}&skipintro=true"
                                                                       target="_blank"><i class="fa fa-link"></i></a>
                                                                    <a data-toggle="modal" data-target=".bs-edit-scena"
                                                                       data-name="${scena.name}"
                                                                       data-tourid="${panoTourSrc.id}" href=""><i
                                                                            class="fa fa-pencil"
                                                        ...
                                                        <div class="caption">
                                                            <p><c:if test="${scena.showCustomerInfo}"><i class="fa fa-eye"></i></c:if>&nbsp;${scena.title}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </c:forEach>
                                                ...
                                                <div class="col-md-12">
                                                    <section class="language-markup language-actionscript">
                                                        <pre class="codescroll">
                                                            <code class="language-markup language-actionscript"><c:out value="${panoTourSrc.srcXml}" escapeXml="true"/></code>
                                                        </pre>
                                                    </section>
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">${panoTourSrc.name}</h4>
                    </div>
                    <div class="modal-body">
                        <form id="scenaForm" data-parsley-validate="" novalidate="">
                            ...
                            <input type="hidden" id="panoTourSrc.id"/>
                        </form>
...
<script src="../js/panoTourSrcEdit-act.js"></script>
</body>
</html>