                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="krpanoconfigedit-0">Создать конфигурацию</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="x_content">
                            <div class="row">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:forEach items="${krpanoConfigList}" varStatus="vs">
                                        <tr id="${krpanoConfigList[vs.index].id}">
                                            <th scope="row">
                                                <a href="krpanoconfigedit-${krpanoConfigList[vs.index].id}">
                                                    <i class="fa fa-edit" title="Изменить"></i>
                                                </a>&nbsp;
                                                <a data-toggle="modal" data-target=".bs-remove-krpanoconfig"
                                                   data-data="${krpanoConfigList[vs.index].id}" title="Удалить"><i
                                                        class="fa fa-remove"></i></a>&nbsp;&nbsp;
                                                <i class="fa fa-cogs" style="font-size: 18px;"></i>
                                            </th>
                                            <td>${krpanoConfigList[vs.index].path}</td>
                                            <td>${krpanoConfigList[vs.index].name}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                                <div class="modal fade bs-remove-krpanoconfig" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel2">Удалить конфигурацию</h4>
                                            </div>
...
<script src="../js/krpanoconfigs.js" type="text/javascript"></script>
</body>
</html>