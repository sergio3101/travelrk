                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="main">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10"><a href="https://pano.travelrk.ru/rentatours/${rentaTour.path}/"
                                                                          target="_blank">https://pano.travelrk.ru/rentatours/${rentaTour.path}</a>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <section class="language-markup">
                                                        <pre class="language-html pre-wrap"><code><c:set var = "iframe" value = '<iframe src="https://pano.travelrk.ru/rentatours/${rentaTour.path}/" id="tour_frame" width="700" height="410" border="0" frameborder="0" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" style="width: 100%;max-width: 100%;"></iframe>'/>${fn:escapeXml(iframe)}</code></pre>
                                                    </section>
                                                </div>
                                            </div>
                                        </div>
