...
<head>
    ...
    <title>Тур - ${panoTourRenta.name}</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Арендный тур -
                                <small>${panoTourRenta.name}</small>
                            </h2>
                            <div class="clearfix"></div>
                            <form:errors path="rentaTour"/>
                        </div>
                        <div class="x_content">
                            <form:form method="post" commandName="panoTourRenta" id="panoTourRenta"
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <a href="/admin/panotourrenta" class="btn btn-info pull-right"
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="main">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">${panoTourRenta.dateOfCreate}</div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-2"><strong>Тур создал:</strong></div>
                                                <div class="col-md-10">${panoTourRenta.user.fio}</div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2"
                                                       for="description">PanoTour исходник *:</label>
                                                <div class="col-md-10">
                                                    <div class="input-group input-group-sm col-md-10">
                                                        <form:select path="panoTourSrc.id" items="${panoTourSrcs}"
                                        ...
                                        <div class="tab-pane" id="rentatab">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-2"
                                                       for="description">Панорама по-умолчанию:</label>
                                                <div class="col-md-10">
                                                    <div class="input-group input-group-sm col-md-10">
                                                        <form:select path="defaultPano" items="${rentaTourScenas}"
                                                                     itemValue="name" itemLabel="title"
                                                                     cssClass="form-control field col-md-10">
                                                        </form:select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <form:label path="scenasFowShow"
                                                            cssClass="control-label col-md-2">Панорамы для аренды:</form:label>
                                                <div class="col-md-10">
                                                    <form:select multiple="true" path="scenasFowShow" size="10" cssStyle="width: 100%; resize: auto;"
                                                                 items="${rentaTourScenas}" itemValue="id" itemLabel="title"/>
                                                </div>
                                            </div>
                                        </div>
...
<script src="../js/panoTourRentaEdit-act.js"></script>
</body>
</html>